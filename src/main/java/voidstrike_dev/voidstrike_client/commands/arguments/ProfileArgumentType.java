...
import voidstrike_dev.voidstrike_client.systems.profiles.Profile;
...
public class ProfileArgumentType implements ArgumentType<String> {
    ...
    private static final Collection<String> EXAMPLES = List.of("pvp.voidstrike_client.com", "anarchy");
