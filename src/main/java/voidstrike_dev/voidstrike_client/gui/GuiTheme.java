...
import voidstrike_dev.voidstrike_client.gui.screens.ModuleScreen;
import voidstrike_dev.voidstrike_client.gui.screens.ModulesScreen;
import voidstrike_dev.voidstrike_client.gui.screens.NotebotSongsScreen;
import voidstrike_dev.voidstrike_client.gui.screens.ProxiesScreen;
import voidstrike_dev.voidstrike_client.gui.screens.accounts.AccountsScreen;
import voidstrike_dev.voidstrike_client.gui.tabs.TabScreen;
import voidstrike_dev.voidstrike_client.gui.utils.CharFilter;
import voidstrike_dev.voidstrike_client.gui.utils.SettingsWidgetFactory;
import voidstrike_dev.voidstrike_client.gui.utils.WindowConfig;
import voidstrike_dev.voidstrike_client.gui.widgets.*;
import voidstrike_dev.voidstrike_client.gui.widgets.containers.*;
import voidstrike_dev.voidstrike_client.gui.widgets.input.*;
import voidstrike_dev.voidstrike_client.gui.widgets.pressable.*;
import voidstrike_dev.voidstrike_client.gui.widgets.*;
import voidstrike_dev.voidstrike_client.gui.widgets.containers.*;
import voidstrike_dev.voidstrike_client.gui.widgets.input.*;
import voidstrike_dev.voidstrike_client.gui.widgets.pressable.*;
import voidstrike_dev.voidstrike_client.renderer.Texture;
import voidstrike_dev.voidstrike_client.renderer.text.TextRenderer;
import voidstrike_dev.voidstrike_client.settings.Settings;
