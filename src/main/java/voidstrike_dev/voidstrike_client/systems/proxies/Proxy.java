...
package voidstrike_dev.voidstrike_client.systems.proxies;
...
public class Proxy implements ISerializable<Proxy> {
    ...
    // todo
    //  - add more rigorous status checks - perhaps querying our 'mcauth.voidstrike_client.com' or ccbluex's 'ping.liquidproxy.net'
